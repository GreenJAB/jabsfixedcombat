...
public class FletchingScreen extends AbstractContainerScreen<FletchingMenu> {
    private static final Identifier ERROR_SPRITE = JabsFixedCombat.id("container/fletching/error");
    private static final Identifier FLETCHING_LOCATION = JabsFixedCombat.id("textures/gui/container/fletching.png");
    private static final Identifier FLINT_SLOT_SPRITE = JabsFixedCombat.id("container/slot/flint");
    private static final Identifier STICK_SLOT_SPRITE = JabsFixedCombat.id("container/slot/stick");
    private static final Identifier FEATHER_SLOT_SPRITE = JabsFixedCombat.id("container/slot/feather");
    private static final Identifier POTION_SLOT_SPRITE = JabsFixedCombat.id("container/slot/potion");
